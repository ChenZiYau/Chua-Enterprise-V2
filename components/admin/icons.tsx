...
export const IconQuickEntry = (p: IconProps) => (
...
export const IconExternal = (p: IconProps) => (
  <svg {...base} {...p}><path d="M14 4h6v6"/><path d="M20 4 10 14"/><path d="M19 13v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h6"/></svg>
);
